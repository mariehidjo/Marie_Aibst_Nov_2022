...
```{r}
library(DropletUtils)
sce <- DropletUtils::read10xCounts(samples = c("Raw" = "C:/Users/Administrator/OBDS_training/Week3/Droplet_and_ambientRNA/raw_feature_bc_matrix/"),col.names = TRUE)
...
sce_decontX_filter <- sce_decontX[, sce_decontX$decontX_clusters_contMinTion < 0.75]
plotReducedDim(sce_decontX_filter, dimred = "decontX_UMAP", colour_by = 
