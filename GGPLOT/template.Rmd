...
library(cowplot)
first_row <- cowplot::plot_grid(obds_chickweight,obds_diamionds, nrow = 1
...
(obds_chickweight + obds_diamionds) / (obds_msleep)
...
library(gridExtra)
gridExtra::grid.arrange(obds_chickweight, obds_diamionds,obds_msleep, ncol = 3, nrow = 2)
